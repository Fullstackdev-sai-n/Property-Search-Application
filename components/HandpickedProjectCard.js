class HandpickedProjectCard extends HTMLElement {
	...
	async connectedCallback() {
	  ...
	  this.attachShadow( { mode: 'open' } )
		  ...
		  this.shadowRoot.querySelector('.hnp-image-content-block').addEventListener('mouseover', () => {
		  ...
		  this.shadowRoot.querySelector('.hnp-image-content-block').addEventListener('mouseout', () => {
